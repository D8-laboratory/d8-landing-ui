...
const TALLY_URL = "https://tally.so/r/ODPPB8";
        ...
        {({ open }) => (
          <>
            ...
            <Transition
              ...
              as="div"
            >
              <DisclosurePanel className="flex flex-col overflow-hidden left-0 h-full w-full sm:w-[400px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                <iframe
                  src={TALLY_URL}
                  width="100%"
                  height="100%"
