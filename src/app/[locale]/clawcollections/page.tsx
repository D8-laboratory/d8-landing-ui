    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {/* ClawCollections */}
          <div className="p-8 rounded-2xl bg-indigo-600 text-white shadow-2xl">
            <h3 className="text-2xl font-bold mb-2">ClawCollections</h3>
          ...
          {/* vs MooFlow */}
          <div className="p-8 rounded-2xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">MooFlow</h3>
          ...
          {/* vs Traditional CRM */}
          <div className="p-8 rounded-2xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2"><TranslatedText i18nKey="clawcollections.vsTraditional" /></h3>
            <div className="w-12 h-1 bg-gray-400 mb-6"></div>
            <ul className="space-y-3 text-gray-600 dark:text-gray-400">
      ...
      <section className="bg-indigo-600 dark:bg-indigo-700 py-20">
        <div className="container mx-auto px-8 text-center space-y-6">
          ...
          <button className="px-10 py-4 bg-white text-indigo-600 rounded-xl font-bold text-lg hover:bg-indigo-50 transition-colors shadow-lg">
